/* =============================================================
   HRA ACCOUNTANT – MAIN JAVASCRIPT (FULL, SMOOTH SCROLL WORKING)
   ============================================================= */
(function () {
  'use strict';

  /* ---------- SIMPLE SMOOTH SCROLL (native smooth behavior) ---------- */
  const SCROLL_FACTOR = 0.5;  // 1 = normal, 0.5 = slower premium feel
